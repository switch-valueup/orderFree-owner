    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMenuButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), com.example.userapplication.UI.mainview.menu.addMenuActivity.class);
        ...
        mOrderListButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), com.example.userapplication.UI.mainview.order.orderlistActivity.class);
                startActivity(intent);
            }
        });
        ...
        mSellStatusButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), com.example.userapplication.UI.mainview.activity.SellStatusActivity.class);
                startActivity(intent);
            }
        });
        ...
        mPersonInfoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), com.example.userapplication.UI.mainview.activity.personInfoActivity.class);
